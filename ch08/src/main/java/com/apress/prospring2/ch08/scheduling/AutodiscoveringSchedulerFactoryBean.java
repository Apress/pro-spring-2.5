 ...
 *
 * @author Juergen Hoeller, Jan Machacek
 * @since 18.02.2004
 * @see #setDataSource
 ...
 */
public class AutodiscoveringSchedulerFactoryBean
     ...
     * @param schedulerFactoryClass The factory class
     * @see org.quartz.impl.StdSchedulerFactory
     ...
     * @param nonTransactionalDataSource The DS
     * @see #setDataSource
     * @see org.springframework.scheduling.quartz.LocalDataSourceJobStore
     */
     ...
     * @param transactionManager The TM
     * @see #setDataSource
	 */
     ...
     * @param applicationContextSchedulerContextKey The Key
	 ...
	 * <p>Specify an instance of Spring's {@link org.springframework.scheduling.quartz.SpringBeanJobFactory} here
	 * (typically as an inner bean definition) to automatically populate a
	 * job's bean properties from the specified job dataaccess map and scheduler
	 * context.
     ...
     * @param overwriteExistingJobs True to overwrite the jobs
     */
     ...
     * @param jobSchedulingDataLocation The dataaccess location
	 ...
	 * to jobs defined directly on this SchedulerFactoryBean.
     * @param jobSchedulingDataLocations The locations
     * @see org.springframework.scheduling.quartz.ResourceJobSchedulingDataProcessor
     * @see org.quartz.xml.JobSchedulingDataProcessor
	 */
     ...
     * @param schedulerListeners The listeners
     */
     ...
     * @param globalJobListeners The listners
     */
	 ...
	 * them via their name.
     * @param jobListeners The listeners
     ...
     * @param globalTriggerListeners The listeners
     */
	 ...
	 * them via their name.
     * @param triggerListeners The listeners
     ...
     * @see org.springframework.scheduling.quartz.SimpleTriggerBean#setTriggerListenerNames
	 */
     ...
     * Default is "false".
     * @param waitForJobsToCompleteOnShutdown Set to true to make the bean wait for completion of all jobs
    ...
    @SuppressWarnings({"unchecked"})
    private synchronized void autodiscoverJobsAndTriggers() {
        if (this.triggers == null) {
            this.triggers = new LinkedList();
        }
        Map triggers = this.applicationContext.getBeansOfType(JobDetailAwareTrigger.class);
        this.triggers.addAll(triggers.values());
    }
     ...
     * @throws java.io.IOException Initialize the factory
     * @throws org.quartz.SchedulerException If the scheduler cannot be initialized
	 */
     ...
     * @throws org.quartz.SchedulerException Something
     */
     ...
     * @throws org.quartz.SchedulerException Register listeners
     */
	private void registerListeners() throws SchedulerException {
		...
		if (this.globalJobListeners != null) {
            for (JobListener globalJobListener : this.globalJobListeners) {
                this.scheduler.addGlobalJobListener(globalJobListener);
            }
        }
		...
		if (this.globalTriggerListeners != null) {
            for (TriggerListener globalTriggerListener : this.globalTriggerListeners) {
                this.scheduler.addGlobalTriggerListener(globalTriggerListener);
            }
        }
     ...
     * @throws org.quartz.SchedulerException Register all jobs and triggers
     */
	private void registerJobsAndTriggers() throws SchedulerException {
		...
		try {
			...
			if (this.jobSchedulingDataLocations != null) {
                ...
                for (String jobSchedulingDataLocation : this.jobSchedulingDataLocations) {
                    dataProcessor.processFileAndScheduleJobs(
                            jobSchedulingDataLocation, this.scheduler, this.overwriteExistingJobs);
                }
            }

			// Register JobDetails.
			if (this.jobDetails != null) {
                for (Object jobDetail1 : this.jobDetails) {
                    JobDetail jobDetail = (JobDetail) jobDetail1;
			...
			if (this.calendars != null) {
                for (Object o : this.calendars.keySet()) {
                    String calendarName = (String) o;
			...
			// Register Triggers.
			if (this.triggers != null) {
                for (Object trigger1 : this.triggers) {
                    Trigger trigger = (Trigger) trigger1;
     ...
     * @throws org.quartz.SchedulerException if something goes wrong
	 */
     ...
     * @throws org.quartz.SchedulerException If the scheduler cannot start
	 */
